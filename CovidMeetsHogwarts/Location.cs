    ...
    public class Location
    {
        ...
        void AddHuman(bool randomValues)
        {
            ...
            if (randomValues)
            {
                ...
                double social_distance = rnd.NextDouble();
                double hygiene = rnd.NextDouble();
                double travelling_rate = rnd.NextDouble();
                h = new Human(hygiene, social_distance, travelling_rate);
            }
            else
            {
                h = new Human(Human.GLOBAL_HYGIENE, Human.GLOBAL_SOCIAL_DISTANCE, Human.GLOBAL_TRAVELLING_RATE);
            }
            humans.Add(h);
        }
